...
var SearchElement = /*#__PURE__*/function (_HTMLElement) {
  _inherits(SearchElement, _HTMLElement);
  var _super = _createSuper(SearchElement);
...
// EXTERNAL MODULE: ./src/js/search-el.js
var search_el = __webpack_require__(24);
...
// Search
var searchValue = document.querySelector("search-element");

// Filter Text
var filterText = document.getElementById("filter-text");

// Filter Button
var filterRegionButton = document.getElementById("filter-region");
var dropdownFilter = document.getElementById("dropdown-filter");
var listDropdownFilter = document.querySelectorAll(".list-filter");
...
function insertCountry(imageCountry, nameCountry, populationCountry, regionCountry, capitalCountry) {
  return "\n        <div class=\"flag-container shadow-[0px_0px_13px_0px_rgba(0,0,0,0.15)] rounded-md overflow-hidden dark:bg-dark-mode-element\" data-region=\"".concat(regionCountry, "\">\n            <div class=\"h-36\">\n                <img class=\"w-full h-full object-cover\" src=\"").concat(imageCountry, "\" alt=\"\">\n            </div>\n            <div class=\"px-5 py-6 mb-4\">\n                <h1 class=\"font-extrabold text-lg mb-3 font-nunito transition duration-300 dark:text-white\">").concat(nameCountry, "</h1>\n                <p class=\"font-semibold transition duration-300 dark:text-white lg:text-sm\">Population: <span class=\"font-light\">").concat(populationCountry, "</span></p>\n                <p class=\"font-semibold transition duration-300 dark:text-white lg:text-sm\">Region: <span class=\"font-light\">").concat(regionCountry, "</span></p>\n                <p class=\"font-semibold transition duration-300 dark:text-white lg:text-sm\">Capital: <span class=\"font-light\">").concat(capitalCountry, "</span></p>\n            </div>\n        </div>\n    ");
}
...
function checkPreviousData() {
  if (sessionStorage.getItem("filter-text") !== null) {
    ...
    xhr.open('GET', "https://restcountries.com/v3.1/region/".concat(newFilterText), true);
    xhr.send();
  }
}
jquery_default()("#filter-region").click(function () {
...
searchValue.addEventListener("keyup", function () {
  ...
  xhr.open('GET', "https://restcountries.com/v3.1/name/".concat(inputUser), true);
  xhr.send();
});
generateFirstData();
checkDarkMode();
...
listDropdownFilter.forEach(function (i) {
  i.addEventListener("click", function () {
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState == 4 && xhr.status == 200) {
        ...
        for (var j = 0; j < finalResult.length; j++) {
          // Only data at index 4 and 3 (Asia Region) that return undefined value
          if (j === 4 || j === 3) {
            continue;
          }
    ...
    xhr.open('GET', "https://restcountries.com/v3.1/region/".concat(i.textContent), true);
    xhr.send();
  });
});
